...
class RestExceptionHandler {
    ...
    @ExceptionHandler(CordaFlowTimeoutException::class)
    fun cordaFlowTimeoutException(e: CordaFlowTimeoutException): ResponseEntity<ProblemDetail> {
        return ResponseEntity(ProblemDetail(type = e.javaClass.name, title = e.message), HttpStatus.ACCEPTED)
    }
}