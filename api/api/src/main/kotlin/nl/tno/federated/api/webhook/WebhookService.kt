...
class WebhookService(
    ...
    fun register(w: Webhook): Webhook {
        val save = webhookRepository.save(WebhookEntity(clientId = w.clientId, eventType = w.eventType, callbackURL = w.callbackURL.toString(), tokenURL = w.tokenURL?.toString(), extraVariables= w.extraVariables?.toString(),  id = null))
