...
//
//        val response = testRestTemplate.postForEntity("/events", HttpEntity(""), String::class.java)
//
//        assertEquals(HttpStatus.CREATED, response.statusCode)
...
//        }
//
//        val response = testRestTemplate.postForEntity("/events", HttpEntity("", headers), String::class.java)
//
//        assertEquals(HttpStatus.BAD_REQUEST, response.statusCode)
//        assertTrue("The missing destination fields have not been identified", response.body!!.contains("Missing destination field"))
//    }
