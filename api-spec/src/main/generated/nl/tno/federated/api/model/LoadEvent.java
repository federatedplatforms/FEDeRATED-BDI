...
public class LoadEvent {
  ...
  /**
   * Default constructor
   * @deprecated Use {@link LoadEvent#LoadEvent(List<@Valid Actor>, TransportMeans, OffsetDateTime, TimeClassificationEnum)}
   */
  @Deprecated
  public LoadEvent() {
    super();
   ...
   */
  public LoadEvent(List<@Valid Actor> involvedActors, TransportMeans transportMeans, OffsetDateTime timestamp, TimeClassificationEnum timeClassification) {
